...
function next(){
    window.open('./henkin.html','_blank');
}
...
function draw(){
    ...
    case Mode.result:
        ...
        if(!resultDisplayed){
            ...
            //nameList=["津川","国吉","山城","倉岡"]
        
            nameList=sessionStorage.getItem("namelist");
            nameList=nameList.split(',')
            addList = sessionStorage.getItem("addlist");
            addList = addList.split(',');
            sessionStorage.setItem("winnerAdd",addList[result]);
            sessionStorage.setItem("winnerName",nameList[result]);
        
            $('#result').html(nameList[result]+" さん");
